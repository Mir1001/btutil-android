...
import com.mir1001.btutil.dialog.BTDevicePickerActivity;
...
public class MainActivityExample extends AppCompatActivity {
    ...
    private static final int REQUEST_SELECT_BT = 1212;
    ...
    void pickBT() {
        BTDevicePickerActivity.handler = btHandler;
        Intent start = new Intent(this, BTDevicePickerActivity.class);
        //startActivityForResult(start,REQUEST_SELECT_BT);
        startActivity(start);
    }
